...
-- ---------------------------------------------------------------------------
--
-- Va al final a propósito: un GRANT necesita que el objeto ya exista, y la
-- vista de saldos se crea justo arriba.
--
-- El proyecto se creó con «exponer tablas nuevas automáticamente» apagado,
-- así que nada es alcanzable por la API hasta que se le dé permiso aquí. Es
-- una segunda barrera detrás de RLS: si algún día se agrega una tabla y se
-- olvida su política, no queda expuesta por descuido.
--
